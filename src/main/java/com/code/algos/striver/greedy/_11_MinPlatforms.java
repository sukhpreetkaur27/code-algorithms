...
but we can have arrival time of one train equal to departure time of the other. At any given instance of time, same platform can not be used for both departure of a train 
...
array dep[] (denoting the departure times) and the size of the array as inputs and returns the minimum number of platforms required at the railway station 
...
public class _11_MinPlatforms {
  ...
  public int findPlatform(int arr[], int dep[], int n) {
    ...
    /**
     * start with arr[1] as arr[0] will any way occupy a platform
     */
    int a = 1;
    /**
     * start with dep[0] to compare with arr[1]
     */
    int d = 0;
    ...
    while (a < n) {
      /**
       * if departure >= arrival <br>
       * occupy a new platform
       */
      if (dep[d] >= arr[a]) {
        a++;
        count++;
